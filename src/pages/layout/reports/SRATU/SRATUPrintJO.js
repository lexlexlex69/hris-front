...
export const SRATUPrintJO = React.forwardRef((props,ref)=>{
    ...
    return (
        <div id='sratu' ref ={ref} style={{fontFamily:'cambria'}}>
            <div style={{display:'flex',flexDirection:'row',justifyContent:'center'}}>
                ...
                <div>
                <img src={props.letterHead} height='100px' width='800px'/>
                    ...
                    <tbody>
                        {
                            props.data.map((row,key)=>
                                <tr key={key} style={{textAlign:'center'}}>
                                    ...
                                    <td>
                                        {formatWithCommas(((row.rate/12)/22).toFixed(0))}
                                    </td>
                                    <td>
                                        11
                                    </td>
