...
import { searchEmployeePerDept, updateMRATUSignatories } from '../MRATURequest';
        ...
        Swal.fire({
            ...
            if(res.isConfirmed){
                ...
                */
                ...
                updateMRATUSignatories(row)
                .then(res=>{
                    if(res.data.status === 200){
                        props.setOpenSearchEmployee(false)
                        props.setMratuPreparedByName(res.data.data.prepared_by_name);
                        props.setMratuPreparedByPos(res.data.data.prepared_by_pos);
                        props.setMratuDeptHeadName(res.data.data.dept_head_name);
                        props.setMratuDeptHeadPos(res.data.data.dept_head_pos);
                        Swal.fire({
                            icon:'success',
