                                        ...
                                        {Object.keys(toUpdated).map((items, index) => (
                                            <>
                                                <TableRow display='flex' sx={{ bgcolor: 'warning.main' }}>
                                                    ...
                                                    <TableCell display='flex'>
                                                        {toUpdatedBackend.filter(y => parseInt(y.id) === parseInt(toUpdated[items][index].row_index))[0]?.nohours}
                                                    </TableCell>
                                                    <TableCell display='flex'>
                                                        {toUpdatedBackend.filter(y => parseInt(y.id) === parseInt(toUpdated[items][index].row_index))[0]?.typeLD}
                                                    </TableCell>
                                                    <TableCell display='flex'>
                                                        {toUpdatedBackend.filter(y => parseInt(y.id) === parseInt(toUpdated[items][index].row_index))[0]?.conducted}
                                                    </TableCell>
                                                    <TableCell display='flex'>
                                                    </TableCell>
                                                </TableRow>
                                                    ...
                                                    {toUpdated[items]?.map((x, i) => (
                                                        <>
                                                            ...
                                                            <TableCell sx={{ verticalAlign: 'top' }}>
                                                                <Typography variant="body2" color="warning.main">[{x.table_field === 'title' ? "TITLE OF LEARNING AND DEVELOPMENT INTERVENTIONS/TRAINING PROGRAMS" : x.table_field === 'datefrom' ? 'FROM' : x.table_field === 'dateto' ? 'TO' : x.table_field === 'nohours' ? 'NUMBER OF HOURS' : x.table_field === 'typeLD' ? 'Type of LD Managerial/Supervisory/Technical/etc' : x.table_field === 'conducted' ? 'CONDUCTED/SPONSORED' : ''}]</Typography>
