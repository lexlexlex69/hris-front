...
import { getEmployeeStatus,getEmployeeGenderInfoPerOffice } from '../Controller'
...
function MaleFemale(props) {
    ...
    const handleChange = (event, value) => {
        setPage(value);
        getEmployeeGenderInfoPerOffice(category, setTableState, setLoader, setCount, value, setPage,props.category)
    };

    useEffect(() => {
        let cat = props.category === 'MALE' ? 'Male' : props.category === 'FEMALE' ? 'Female' : null
        console.log(cat)
        axios.post(`/api/dashboard/data_analytics/getEmployeeStatusByGender`, {
            category: cat
        })
            .then(res => {
                console.log(res)
                            ...
                            point: {
                                events: {
                                    click: (e) => {
                                        ...
                                        getEmployeeGenderInfoPerOffice(e.point.category, setTableState, setLoader, setCount, '', setPage,props.category)
                                    }
                                }
                            }
                        }
