...
import { getEmployeeInfoPerOffice } from '../Controller'
...
function TotalEmployee() {
    ...
    const handleChange = (event, value) => {
        setPage(value);
        getEmployeeInfoPerOffice(category, setTableState, setLoader, setCount, value, setPage)
    };

    useEffect(() => {
        axios.post(`/api/dashboard/data_analytics/getEmployeesPerOffice`)
            .then(res => {
                console.log(res)
                let categories = []
                let count = []
                ...
                setOptions({
                    ...
                    subtitle: {
                        text: 'Total employees per offices'
                    },
                    xAxis: {
                            ...
                            point: {
                                events: {
                                    click: (e) => {
                                        ...
                                        getEmployeeInfoPerOffice(e.point.category, setTableState, setLoader, setCount, '', setPage)
                                    }
                                }
                            }
                        }
...
export default React.memo(TotalEmployee)