...
export default function LeaveApplicationForm(props){
    ...
    return(
        <>
        {
            ...
            ?
            <Box>
                <Box sx={{maxHeight:'50vh',overflowY:'scroll',padding:'20px 5px 20px 5px'}}>
                        ...
                        {leaveType
                            ...
                            <Tooltip title ='Save Leave Application'><Button sx={{'&:hover':{color:'white',background:green[800]}}} variant='outlined' color="success" onClick = {submitApplication} disabled = {
                                leaveType === 14
                                ?
                                ...
                                :
                                    ...
                                    :
                                    false
                                } startIcon={<SaveOutlinedIcon/>} size={'small'}>Save</Button></Tooltip>
                                &nbsp;
                ...
                >
                    <Box sx={previewStyle}>
                        ...
                        <Box sx={{maxHeight:'70vh',overflowY:'scroll',mt:2,mb:2}}>
                        {
                        leaveType === 14
                        ?
                        <div>
                            <PreviewCTOApplicationForm info={employeeInfo} auth_info={props.authInfo} coc = {balanceData.length !==0 ? balanceData[0].coc_bal:0} CTOHours = {CTOHours} cto_dates = {ctodatestext} date_of_filing ={new Date()}/>
                        </div>
                        :
                ...
                <div style={{ display: "none" }}>
                    <PreviewCTOApplicationForm ref={cocRef} info={employeeInfo} auth_info={props.authInfo} coc = {balanceData.length !==0 ? balanceData[0].coc_bal:0} CTOHours = {CTOHours} cto_dates = {ctodatestext} date_of_filing ={new Date()}/>
                </div>
                </Box>
            :
            <Stack>
