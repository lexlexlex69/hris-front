...
export const AllocationOfMaternityLeaveForm = React.forwardRef((props,ref)=>{
            ...
            <Grid container>
                ...
                <Grid container sx = {{marginTop:'10px',display:'flex',flexDirection:'row' ,border:'solid 1px'}}>
                    ...
                    <Grid item xs = {12} sx={{padding:'10px'}}>
                        <Typography sx={{fontSize:'10px',textIndent:'30px'}}>I am allocating <strong><span style = {{borderBottom:'solid 1px'}}>&nbsp;{props.info.allocation_number_days}&nbsp;</span></strong> days (7 days max.) of my 105-day maternity leave to Mr./Ms. <strong><span style = {{borderBottom:'solid 1px'}}>&nbsp;{props.info.benefit_fullname}&nbsp;</span></strong>,
    ...
    height: '50px',top:'-15px',left:'50px'}}/>
                            <strong>____________<u>{props.info.benefit_fullname}</u>__________</strong><br/>
                                SIGNATURE OVER PRINTED NAME
                            </Typography>
                            </div>
