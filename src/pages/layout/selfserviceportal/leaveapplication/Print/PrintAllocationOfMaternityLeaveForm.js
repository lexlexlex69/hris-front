...
export const PrintAllocationOfMaternityLeaveForm = React.forwardRef((props,ref)=>{
    return(
                    ...
                    <Grid item xs = {5} sx={{borderBottom:'solid 1px',borderRight:'solid 1px'}}>
                        <Box sx={{display:'flex',flexDirection:'column'}}>
                            ...
                            <Typography sx={{fontSize:'10px', padding:'5px 10px 0 10px'}}>
                                <input className='ex' type = "checkbox" readOnly defaultChecked = {props.info.benefit_relationship === "Childs father" ? true:false}/> Child’s father
                            </Typography>
                            <Typography sx={{fontSize:'10px', paddingLeft:'10px'}}>
                                <input type = "checkbox" readOnly defaultChecked = {props.info.benefit_relationship === 'Alternate caregiver' ? true:false}/> Alternate caregiver
                            </Typography>
                            <Typography sx={{fontSize:'10px', paddingLeft:'24px'}}>
                                <input type = "checkbox" readOnly defaultChecked = {props.info.benefit_relationship === 'Alternate caregiver' ?props.info.benefit_relationship_details === "Relative within fourth degree of consanguinity" ? true:false:false}/> Relative within fourth degree of consanguinity<br/>
                            ...
                            <Typography sx={{fontSize:'10px', paddingLeft:'24px'}}>
                                <input type = "checkbox" readOnly defaultChecked = {props.info.benefit_relationship === 'Alternate caregiver' ?props.info.benefit_relationship === "Current partner sharing the same household" ? true:false :false}/> Current partner sharing the same household
                            </Typography>
                            </Grid>
                        </Box>
    ...
    height: '50px',top:'-15px',left:'50px'}}/>
                ...
                <Grid container sx = {{marginTop:'15px',display:'flex',flexDirection:'row' ,border:'solid 1px'}}>
                    ...
                    <Grid item xs = {3} sx={{borderRight:'solid 1px',padding:'10px 0 0 0',height:'60px'}}>
                            <Typography sx={{fontSize:'10px', paddingLeft:'10px'}}>
                                <input type = "checkbox" readOnly defaultChecked = {props.info.benefit_proof_relationship === "Childs Birth Certificate" ? true:false}/> Child’s Birth Certificate
                            </Typography> 
                    </Grid>
                    <Grid item xs = {3} sx={{borderRight:'solid 1px',padding:'10px 0 0 0',height:'60px'}}>
                            <Typography sx={{fontSize:'10px', paddingLeft:'10px'}}>
                                <input type = "checkbox" readOnly defaultChecked = {props.info.benefit_proof_relationship === "Marriage Certificate" ? true:false}/> Marriage Certificate
                            </Typography> 
                    </Grid>
                    <Grid item xs = {3} sx={{borderRight:'solid 1px',padding:'10px 0 0 0',height:'60px'}}>
                            <Typography sx={{fontSize:'10px', paddingLeft:'10px'}}>
                                <input type = "checkbox" readOnly defaultChecked = {props.info.benefit_proof_relationship === "Barangay Certificate" ? true:false}/> Barangay Certificate
                            </Typography> 
                    </Grid>
                    <Grid item xs = {3} sx={{height:'60px',padding:'10px 0 0 0'}}>
                            <Typography sx={{fontSize:'10px', paddingLeft:'10px'}}>
                                <input type = "checkbox" readOnly defaultChecked = {props.info.benefit_proof_relationship === "Other bona fide document/s that can prove filial relationship" ? true:false}/> Other bona fide document/s that can prove filial relationship
                            </Typography> 
                    </Grid>
                </Grid>
                <Grid item xs = {12} sx={{marginTop:'15px', borderTop:'solid 2px'}}>
...
export default PrintAllocationOfMaternityLeaveForm
