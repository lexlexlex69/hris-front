...
export default function EarnExtendedMaternityLeaveFillout(props){
     // media query
    ...
    useEffect(()=>{
        ...
        // setemployeeContactDetails(props.employeeInfo.benefit_contact_details)
        // setallocatePersonFullname(props.employeeInfo.benefit_fullname)
    ...
    return(
        ...
        <Grid item xs={12} sm={12} md={12} lg={12}>
            ...
            <Grid item xs={12} sm={12} md={12} lg={12}>
                ...
                <TextField label = "NAME (Last Name, First Name, Name Extension, if any, and Middle Name *" defaultValue = {props.employeeInfo.benefit_fullname} InputProps={{inputProps:{readOnly:true}}} variant="outlined" fullWidth placeholder='e.g. De la Cruz, Juan, Jr., Lopez'/>
                </Tooltip>
            </Grid>
            {/* <Grid item xs={12} sm={12} md={12} lg={12}>
            ...
            <Grid item xs={12} sm={12} md={12} lg={12}>
                <TextField label ='POSITION *' defaultValue = {props.employeeInfo.benefit_position} InputProps={{inputProps:{readOnly:true}}} fullWidth/>
            </Grid>
            <Grid item xs={12} sm={12} md={12} lg={12}>
                <TextField label ='HOME ADDRESS *' defaultValue = {props.employeeInfo.benefit_home_address} InputProps={{inputProps:{readOnly:true}}} fullWidth/>
            </Grid>
            <Grid item xs={12} sm={12} md={12} lg={12}>
                <TextField label ='CONTACT DETAILS (Phone number and e-mail address) *' defaultValue = {props.employeeInfo.benefit_contact_details} InputProps={{inputProps:{readOnly:true}}} fullWidth/>
            </Grid>
            <Grid item xs={12} sm={12} md={12} lg={12}>
                <TextField label ='AGENCY / EMPLOYER and ADDRESS *' defaultValue = {props.employeeInfo.benefit_agency_address} InputProps={{inputProps:{readOnly:true}}} fullWidth/>
            </Grid>
            <Grid item xs={12} sm={12} md={12} lg={12}>
                <br/>
