...
export const ReviewCTOApplicationForm = React.forwardRef((props,ref)=>{
    ...
    return(
        ...
        <Grid container sx={{border:'solid 2px'}}>
            ...
            <Grid item xs={5} sx={{borderTop:'solid 1px',padding:'10px'}}>
                ...
                <br/>
                <Typography sx={{textAlign:'center',fontSize:'12px'}}>
                        <span style = {{fontWeight:'bold'}}><u>&nbsp;&nbsp;{props.info.office_head?props.info.office_head.toUpperCase():''}&nbsp;&nbsp;</u></span><br/>
                        {props.info.office_head?props.info.office_head_pos:''}
                    </Typography>
            </Grid>
            ...
            <Grid item xs={7} sx = {{padding:'10px',borderRight:'solid 1px'}}>
                ...
                <br/>
                <Typography sx={{fontSize:'12px'}}>
                       As of <span style ={{fontWeight:'bold',borderBottom:'solid 2px'}}>&nbsp;&nbsp;&nbsp;&nbsp;{moment().subtract('months',1).format('MMMM YYYY')}&nbsp;&nbsp;&nbsp;&nbsp;</span>
                </Typography>
                <br/>
                <br/>
                <Grid container>
                ...
                <br/>
                <Typography sx={{textAlign:'center',fontSize:'12px'}}>
                        <span style = {{fontWeight:'bold'}}><u>
                        {/* {props.cto_info[0].cto_hr_name} */}
                        {/* {JSON.stringify(props.office_ao)} */}
                        {props.info.incharge_name?props.info.incharge_name.toUpperCase():''}
                        </u></span><br/>
                        {/* ({props.cto_info[0].cto_hr_name_pos}) */}
                        ({props.info.incharge_pos?props.info.incharge_pos:''})
