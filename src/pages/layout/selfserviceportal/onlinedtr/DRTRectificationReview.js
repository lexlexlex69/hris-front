...
export default function DTRRectificationReview(){
    ...
    useEffect(()=>{
        ...
        .then(response=>{
            if(response.data){
                setIsLoading(false)
                return getRectificationRequestReviewData()
            }else{
            ...
            <Fade in>
                <Grid container>
                    <Grid item xs={12} sm={12} md={12} lg={12} sx={{margin:'0 0 10px 0'}}>
                        ...
                        <ModuleHeaderText title='DTR Rectification Request Verification'/>
                    </Grid>
                </Grid>
            </Fade>
            }
                ...
                <Fade in = {!isLoading}>
                    <Grid item xs={12}>
                        ...
                        <Grid item xs={12} sx={{mt:2}}>
                            <VerificationHistoryTable cat='verification' type='DEFAULT'/>
                        </Grid>
                        <Modal
                            open={openFile}
