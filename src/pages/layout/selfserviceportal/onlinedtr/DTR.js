        ...
        <Fade in>
            ...
            >
                ...
                <Box sx={{pointerEvents:underDevelopment?'none':'',opacity:underDevelopment?'0.4':'1'}}>
                    ...
                    <Grid container component={Paper} sx={{padding:'10px',mt:1}}>
                        ...
                        <Grid item xs={12} sx={{display:'flex',gap:1,flexDirection:'row',justifyContent:matches?'center':'flex-end'}}>
                        {
                            ...
                            <Tooltip title='File OB-OFT Rectification'><Button variant='contained' startIcon={<PostAddIcon/>} onClick={handleOpenOBOFT}>File OB-OFT</Button></Tooltip>
                            {
                                ...
                                <Tooltip title='Print DTR'><Button variant='contained' onClick = {beforePrint} className='custom-iconbutton' color='info' startIcon={<PrintIcon/>}>Print DTR</Button></Tooltip>
                                </Box>
                        ...
                        <div ref = {printDTR} style={{width:'100%',overflow:matches?'scroll':'auto'}} id = 'dtr-form'>
                            <Grid item xs={12} sx={{display:'flex',flexDirection:'row',margin:'20px'}}>
                                <Grid item xs={6} sx={{margin:'0 10px'}}>
                                    <DTRFormPrint  days = {days} dtrdata = {dtrdata} period={period} info = {employeeInfo} totalUndertimeHours = {totalUndertimeHours} totalUndertimeMinutes={totalUndertimeMinutes} totalLateHours={totalLateHours} totalLateMinutes={totalLateMinutes} officeHead={officeHeadPos} regularDays = {regularDays} timeStamp = {timeStamp}/>
                                </Grid>
                                <Grid item xs={6} sx={{margin:'0 10px'}}>
                                    <DTRFormPrint  days = {days} dtrdata = {dtrdata} period={period} info = {employeeInfo} totalUndertimeHours = {totalUndertimeHours} totalUndertimeMinutes={totalUndertimeMinutes} totalLateHours={totalLateHours} totalLateMinutes={totalLateMinutes} officeHead={officeHeadPos} regularDays = {regularDays} timeStamp = {timeStamp}/>
                                </Grid>
