...
export function getEmpDTR(data){
    return axios.request({
        method:'POST',
        data:data,
        url:'api/DTR/getEmpDTR'
    })
}
...
export function getEmployeeInfo(){
    return axios.request({
        method:'GET',
        url:'api/DTR/getEmployeeInfo'
    })
}
export function getEmployeeInfoDTR(){
    return axios.request({
        method:'GET',
        url:'api/DTR/getEmployeeInfoDTR'
    })
}
...
export function getRectificationRequestReviewData(data){
    return axios.request({
        method:'POST',
        data:data,
...
export function getLogsAdjustmentAPI(data){
    return axios.request({
        method:'POST',
        data:data,
        url:'api/DTR/getLogsAdjustmentAPI'
    })
}
...
export function postOBRectificationHR(data){
    return axios.request({
        method:'POST',
        data:{
            data
        },
        url:'api/DTR/postOBRectificationHR'
    })
}
...
export function getOBRecficationRequest(data){
    return axios.request({
        method:'POST',
        data:data,
        url:'api/DTR/getOBRecficationRequest'
    })
}
export function disapprovedOBRectificationRequest(data){
    return axios.request({
        method:'POST',
        data:data,
        url:'api/DTR/disapprovedOBRectificationRequest'
    })
}
export function approvedOBRectificationRequest(data){
    return axios.request({
        method:'POST',
        data:data,
        url:'api/DTR/approvedOBRectificationRequest'
    })
}
export function approvedBatchOBRectificationRequest(data){
    return axios.request({
        method:'POST',
        data:data,
        url:'api/DTR/approvedBatchOBRectificationRequest'
    })
}
export function cancelOBRectificationRequest(data){
    return axios.request({
        method:'POST',
        data:data,
        url:'api/DTR/cancelOBRectificationRequest'
    })
}
export function disapprovalRectifierRequest(data){
    return axios.request({
        method:'POST',
        data:data,
        url:'api/DTR/disapprovalRectifierRequest'
    })
}
export function deleteRequestedRectification(data){
    return axios.request({
        method:'POST',
        data:data,
        url:'api/DTR/deleteRequestedRectification'
    })
}
export function getRequestedOBOFTRectification(data){
    return axios.request({
        method:'POST',
        data:data,
        url:'api/DTR/getRequestedOBOFTRectification'
    })
}
export function deleteRequestedOBOFTRectification(data){
    return axios.request({
        method:'POST',
        data:data,
        url:'api/DTR/deleteRequestedOBOFTRectification'
    })
}
export function getAllRectificationRequestHistory(data){
    return axios.request({
        method:'POST',
        data:data,
        url:'api/DTR/getAllRectificationRequestHistory'
    })
}
export function getAllDisapprovedRectificationRequestHistory(data){
    return axios.request({
        method:'POST',
        data:data,
        url:'api/DTR/getAllDisapprovedRectificationRequestHistory'
    })
}
export function getAllOBOFTRectificationRequestHistory(data){
    return axios.request({
        method:'POST',
        data:data,
        url:'api/DTR/getAllOBOFTRectificationRequestHistory'
    })
}