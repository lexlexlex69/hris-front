...
import FooterSignature from './pdsPrintables/FooterSignature';
import $ from 'jquery';
...
function PrintPds({ personalInfo, address, family, children, education, workExp, eligibility, voluntary, training, specialSkills, recognition, organization, nNumberOthers, references, _34_40, vacancy_id, applicant_type, govId,defaultEducation }) {
    ...
    useEffect(()=>{
        var lastPage = $("div[id^=pageFooter]").length
        setTotalPages(lastPage)
    },[personalInfo])
    // const showLastPage = ()=>{
    //     lastPage = $("div[id^=pageFooter]").length
    // }
    const pageFooter = ()=>{
        return (
                ...
                <Box>
                        ...
                        <Box sx={{ flex: 1 }}>
                            <Box sx={{ display: 'flex', flexDirection: 'column' }}>
                                <Typography variant="p" sx={{ fontSize: '8px', fontFamily: 'serif', m: 0, p: 0 }}>
                                    <b>
                                        READ THE ATTACHED GUIDE TO FILING OUT THE PERSONAL DATA SHEET (PDS) BEFORE ACCOMSPLISHING THE PDS FORM.
                                    </b>
                                </Typography>
                                <Typography variant="p" sx={{ fontSize: '8px', fontFamily: 'serif', m: 0, p: 0, display: 'flex' }}>
                                    Print legibly. Tick appropriate boxes ( &nbsp; &nbsp;)  &nbsp;<Box><input type="checkbox" /> </Box>  &nbsp; use separate sheet if necessary. Indicate N/A of not applicable. <b>DO NOT ABBRIVIATE.</b>
                                </Typography>
                            </Box>
                        </Box>
                    ...
                    <Box>
                        <AddToPreferencesContext.Provider value={{ toggleModal }} >
                            ...
                            <div className="" style={{width:'100%',position:'relative',top:'-1px' }}>
                            ...
                            {children.length > 12 && (
                                <div className='pds-break-margin-top'>
                                    ...
                                    <div className="" style={{width:'100%',position:'relative',top:10  }}>
                                    <table style={{ width: '100%', margin: 'auto'}}>
                                        <tbody>
                                            <tr>
                                                <td style={{ border: '1px solid black', backgroundColor: '#BEBEBE' }} colSpan={4}>
                        ...
                        {/* <div className="page-footer" style={{ paddingRight: '32px' }}>
                            <table style={{ width: '100%', margin: 'auto' }}>
                                <tbody>
                                    <tr>
                                        <td style={{ border: '1px solid black', backgroundColor: '#BEBEBE' }} colSpan={4}>
