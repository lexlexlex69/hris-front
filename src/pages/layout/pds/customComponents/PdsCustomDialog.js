...
const PdsCustomDialog = ({ children, open, handleClose, fullScreen }) => {
  // media query
  ...
  return (
    <Dialog
      fullScreen
      sx={{ width: fullScreen ? '100vw' : matches ? '100vw' : '40vw',display:'flex',ml: matches ? null :'calc(100vw - 37.5vw)' }}
      open={open}
      onClose={handleClose}
...
export default PdsCustomDialog;