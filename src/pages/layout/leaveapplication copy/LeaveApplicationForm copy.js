...
import {  Typography,Grid,Box, Button,InputLabel,MenuItem,FormControl,Select,TextField,FormControlLabel,FormGroup,LinearProgress,Tooltip,Checkbox,Alert,Fab,CircularProgress,Modal    } from '@mui/material';
// media query
        ...
        <Box sx={{maxHeight:'60vh',overflowY:'scroll',padding:'20px 5px 20px 5px'}}>
                ...
                {leaveType
                    ...
                    <Button variant='contained' color="success" onClick = {submitApplication} disabled = {
                        ...
                        &nbsp;
                    <Button variant='contained' color="error" onClick={()=> props.updatesetOpen(false)} startIcon={<CloseIcon/>}size={'small'}>CANCEL</Button>
                    </Box>
                    </Grid>
                    </>
                    :
