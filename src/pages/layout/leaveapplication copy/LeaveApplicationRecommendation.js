...
import { getRecommendationLeaveApplicationData,getFilterRecommendationLeaveApplicationData,submitLeaveApplicationRecommendation, postApprovalApplicLeaveAPI, postDisApprovalApplicLeaveAPI, postApprovedApplicLeaveAPI } from './LeaveApplicationRequest';
    ...
    const submitApprovedApplication = (row)=>{
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                Swal.showLoading()
                if(row.emp_status === 'RE' || row.emp_status === 'CS'){
                    var data = {
                        ref_no:row.ref_no,
                        emp_no:row.emp_no,
                    ...
                    postApprovalApplicLeaveAPI(approved_data)
                            .then(res=>{
                                ...
                                console.log(approved_data2)
                                postApprovedApplicLeaveAPI(approved_data2)
                                .then(res2=>{
        ...
        <Box sx={{margin:'0 10px 10px 10px',paddingBottom:'20px'}}>
            ...
            <Fade in={!isLoading}>
                ...
                <Box sx={{display:'flex',flexDirection:'row',background:'#008756'}} className='custom-boxshadow'>
                    ...
                    &nbsp;
                    Leave Application Recommendation
                </Typography>
