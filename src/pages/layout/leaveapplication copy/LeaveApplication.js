import { Typography,Grid,Box, Button,InputLabel,MenuItem,FormControl,Select,Modal,TextField,FormControlLabel,FormGroup,LinearProgress,Tooltip,Checkbox,Radio,FormLabel,RadioGroup,Alert,Fab,Fade,CircularProgress, Stack,Skeleton,Badge, TableFooter} from '@mui/material';
                        ...
                        <TableContainer>
                            <Table sx={{ minWidth: 650 }} aria-label="simple table">
                                ...
                                <TableRow
                                    ...
                                    <StyledBalanceTableCell align="right">{parseInt(availableCOC-totalForReview)+parseInt(onProcess.coc)} <small>hr/s</small></StyledBalanceTableCell>
                                    <StyledBalanceTableCell align="right">{onProcess.coc}</StyledBalanceTableCell>
                                    <StyledBalanceTableCell align="right">{availableCOC-totalForReview}</StyledBalanceTableCell>
                                </TableRow>
                                <TableRow
                                    sx={{ '&:last-child td, &:last-child th': { border: 0 } }}
                                    >
