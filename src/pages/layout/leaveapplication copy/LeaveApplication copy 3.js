...
export default function LeaveApplication(props,ref){
    ...
    return(
        <Box sx={{margin:matches?'0 5px 5px 5px':'0 10px 10px 10px',paddingBottom:'20px'}}>
            ...
            <Fade in={!isLoading}>
                <Grid container>
                    <Grid item xs={12} sm={12} md={12} lg={12} component={Paper} sx={{margin:'0 0 10px 0'}}>
                    ...
                    <Grid item xs={12} sm={12} md={12} lg={12} sx={{display:'flex',flexDirection:'row',justifyContent:'flex-end'}}>
                        ...
                        <Tooltip title='Apply Leave Application' placement='top'>
                        <IconButton onClick = {()=>setOpenApplicationDialog(true)} sx={{'&:hover':{color:'#fff',background:green[800]}}}color='success' size={matches?'small':'large'}  className='custom-iconbutton'><AddIcon/></IconButton>
                        </Tooltip>
                        &nbsp;
                        <Tooltip title='Leave Application Ledger' placement='top'>
                        <IconButton onClick = {()=>setOpenLeaveLedgerDialog(true)} sx={{color:blue[500],'&:hover':{color:'#fff',background:blue[800]}}}size={matches?'small':'large'} className='custom-iconbutton'><TextSnippetOutlinedIcon/></IconButton>
                        </Tooltip>
                        &nbsp;
                        <Tooltip title="Refresh Data" placement='top'>
                        <IconButton onClick = {refreshPendingApplication} size={matches?'small':'large'} className='custom-iconbutton'><CachedIcon sx={{color:blue[800],transition:'0.4s ease-in-out','&:hover':{transform:'rotate(-180deg)'}}}/></IconButton>
                        </Tooltip>
                    </Grid>
                        ...
                        <TableContainer>
                            <Table sx={{ minWidth: 650 }} aria-label="simple table">
                                ...
                                <TableRow
                                    ...
                                    <StyledBalanceTableCell align="right">{balanceData[0].vl_bal}</StyledBalanceTableCell>
                                ...
                                <TableRow
                                    ...
                                    <StyledBalanceTableCell align="right">{balanceData[0].coc_bal} <small>hr/s</small></StyledBalanceTableCell>
                                    <StyledBalanceTableCell align="right">{onProcess.coc}</StyledBalanceTableCell>
                                    <StyledBalanceTableCell align="right">{availableCOC <=0?0:availableCOC}</StyledBalanceTableCell>
                                </TableRow>
                                <TableRow
                                    sx={{ '&:last-child td, &:last-child th': { border: 0 } }}
                                    >
