        ...
        <Grid container spacing={1}>
                ...
                <Grid item xs = {12} sx={{marginBottom:'5px'}}>
                    ...
                    <Grid item xs={12} sm = {12} md={6} lg={6}>
                        <Box sx={{display:'flex',flexDirection:'row',justifyContent:'flex-end'}}>
                            ...
                            <Button variant='contained' size='small' onClick = {showAllRectificationRequest2} sx={{fontSize:matches?'10px':'auto',width:matches?'100%':'auto'}} className='custom-iconbutton'> Show All Request</Button>
                            </Tooltip>
                            &nbsp;
                            ...
                            <Tooltip title='Add request' placement='top'>
                                <IconButton color='success' sx={{'&:hover':{color:'#fff',background:green[800]}}} onClick={props.openAddModal} className='custom-iconbutton'> <AddIcon/></IconButton>
                            </Tooltip>
                        </Box>
                                ...
                                <TableBody>
                                    {
                                        ...
                                        props.pendingRectificationData.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map((row,key)=>
                                            <TableRow hover key ={key}>
                                                ...
                                                <IconButton size='small' color='error' onClick={()=>props.cancelApplication(row)} disabled = {row.status === 'FOR REVIEW' || row.status === 'DISAPPROVED' ? false:true} className='custom-iconbutton'><DeleteForeverIcon/></IconButton></span>
                ...
                >
                    <Box style = {style}>
                        ...
                        <Box sx={{m:1,maxHeight:matches?'70vh':'80vh'}}>
