            ...
            return(
                <>
...

                    {
                        ...
                        ?
                        <td><Tooltip arrow title={(<Box><Typography>Rectification Request details: </Typography><Typography sx={{borderTop:'solid 1px',color:'#c4c4c4',mb:1}}></Typography><Typography className ='rectification-details'>Date: {moment(breakin_info.date).format('MMMM DD, YYYY')}</Typography><Typography className ='rectification-details'>Nature: {breakin_info.nature}</Typography><Typography>Reason: {breakin_info.reason}</Typography><Typography className ='rectification-details'>Rectified Time: {formatAMPM(breakin_info.rectified_time)}</Typography><Typography className ='rectification-details'>Status: {breakin_info.status}</Typography></Box>)}><EventNoteOutlinedIcon className = {breakin_info.status === 'APPROVED'?'approved-rectification-icon' :'pending-rectification-icon'}/></Tooltip></td>
                        :
        ...
        <>
            ...
            <Typography sx={{fontSize:'13px',borderBottom:'solid 1px',textAlign:'center',fontFamily:'Times New Roman'}}>
                ...
                <Typography sx={{fontSize:'13px',borderBottom:'solid 1px',textAlign:'center',marginTop:'5px',fontFamily:'Times New Roman'}}>
                    {props.info.officeassign.toUpperCase()}
                ...
                <Grid item xs = {12} sx={{display:'flex',flexDirection:'row',justifyContent:'space-between'}}>
                    ...
                    <Grid item xs = {6}>
                        ...
                        (Regular days)_______________ <br/>
