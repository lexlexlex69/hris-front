    ...
    return(
        ...
        <TableContainer>
          ...
          }}/>
          {
            ...
            ?
                moment(props.selectedTraining.training_details[0].nom_approval_deadline).format('YYYY-MM-DD') < moment(new Date()).format('YYYY-MM-DD')
                ?
                null
                :
                <Tooltip title='Update Approved Trainee'><span><IconButton sx={{float:'right'}} onClick ={props.handleUpdateTrainee} ><EditOutlinedIcon color='success'/></IconButton></span></Tooltip>
