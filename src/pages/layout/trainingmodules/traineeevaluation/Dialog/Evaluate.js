...
import { addTraineeEvaluation, getEvaluateTrainees } from '../TraineeEvaluationRequest';
                                        ...
                                        data.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map((row,key)=>
                                            <TableRow key = {key} hover>
                                                ...
                                                <StyledTableCell>
                                                    ...
                                                    sx={{'&:hover':{color:'#fff',background:blue[800]}}} startIcon={<ContentPasteSearchIcon/>}>Review LAP/SAP</Button>
                                                ...
                                                {/* <RadioGroup
                                                    aria-labelledby="radio-remarks"
                                                    name={"radio-remarks-"+key}
                                                    value={row.remarks}
                                                    onChange={(value)=>handleSetRemarks(key,value)}
                                                    column
                                                >
                                                    <FormControlLabel value={'Fully Implemented'} sx={{color:green[800]}} control={<Radio size='small' sx={{
                                                    color: green[800],
                                                    '&.Mui-checked': {
                                                        color: green[600],
                                                    },
                                                    ...
                                                    <FormControlLabel value={'Partially Implemented'} sx={{color:blue[800]}} control={<Radio size='small' sx={{
                                                    color: blue[800],
                                                    '&.Mui-checked': {
                                                        color: blue[600],
                                                    },
                                                    ...
                                                    <FormControlLabel value={'Not Implemented'} sx={{color:red[800]}} control={<Radio size='small' sx={{
                                                    color: red[800],
                                                    '&.Mui-checked': {
                                                        color: red[600],
                                                    },
