...
import {Box,Grid,IconButton,Tooltip,Typography,Button,Popover} from '@mui/material';
...
const DefaultRequirementsPreview = (props) =>{
        ...
        <Box sx={{position: 'fixed',top: '50%',zIndex: 1,right: '30px'}}>
            {
                ...
                ?
                    props.reqData?.remarks === 'FULLY IMPLEMENTED' || props.reqData?.status.toUpperCase() === 'PARTIALLY IMPLEMENTED'
                    ?
                    <Tooltip title='Print'><Button variant="outlined" color="primary" startIcon={<PrintIcon/>} onClick={reactToPrint}>Print</Button></Tooltip>
                    :
                    ''
                :
                    props.reqData.dept_approved
                    ?
                    <Tooltip title='Print'><Button variant="outlined" color="primary" startIcon={<PrintIcon/>} onClick={reactToPrint}>Print</Button></Tooltip>
                    :
                    ''
            ...
            <Grid container sx={{pl:10,pr:10}}>
                                ...
                                >
                                    <Box sx={{p:1,display:'flex',flexDirection:'column',gap:1}}>
                                    {
                                        fileIDs.map((item,key)=>
                                            <Button variant="outlined" fullWidth onClick={()=>viewFileAPI(item)}>{`File # ${key+1}`}</Button>
                                        )
                                    }
                                    </Box>
                                </Popover>
                ...
                <Grid item xs={12} sx={{display:'flex',flexDirection:'row',gap:20,mt:2}}>
                    ...
                    <Box>
                        ...
                        <Typography sx={{textAlign:'center',mt:2}}><u>{formatManualInputPosition(props.reqData.reviewed_by)}</u></Typography>
...
export default DefaultRequirementsPreview;