...
export default function CustomOptComponent(props){
    return(
        <Grid item xs={12}>
            ...
            <Grid item container spacing={1}>
            {
                ...
                <TextField  value = {data.value} required label ={'#'+(index+1)} fullWidth onChange = {(value) => props.setDataValue(index,value.target.value)}
                />
                {
                    props.data.length === 1
                    ?
