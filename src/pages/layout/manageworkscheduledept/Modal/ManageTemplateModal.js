...
import { getWorkScheduleTemplate,deleteTemplate,getWorkSchedule, getWorkScheduleAPI } from '../WorkScheduleRequest';
        ...
        <Grid container spacing={2}>
            <Grid item xs={12} sx={{display:'flex',flexDirection:'row',justifyContent:'flex-end'}}>
                <Tooltip title='Add New Template'>
                    <Button className='custom-roundbutton' variant='contained' onClick = {()=>setAddModal(true)} color='success'><AddOutlinedIcon/> Add </Button>
                </Tooltip>
            </Grid>
                {
                    loadingData
            ...
            <LargeModal open = {addModal} close = {()=> setAddModal(false)} title='Adding Template Schedule'>
                 <Box>
