...
export function getWorkSchedule(data){
    return axios.request({
        method:'POST',
        data:data,
        // url:'api/workschedule/getWorkSchedule'
        ...
        url:'api/workschedule/getWorkingHrs'
    })
}
...
export function deletePendingSchedule(data){
    return axios.request({
        method:'POST',
        data:data,
        url:'api/workschedule/deletePendingSchedule'
    })
}
...
export function searchFilterDept(data){
    return axios.request({
        method:'POST',
        data:{
            data:data
        },
        url:'api/workschedule/searchFilterDept'
    })
}
...
export function searchDepartmentFilterDept(data){
    return axios.request({
        method:'POST',
        data:{
            data:data
        },
        url:'api/workschedule/searchDepartmentFilterDept'
    })
}
...
export function showTemplateEmployeeListDept(data){
    return axios.request({
        method:'POST',
        data:{
            data:data
        },
        url:'api/workschedule/showTemplateEmployeeListDept'
    })
}
...
export function addEmployeeWorkSchedDept(data){
    return axios.request({
        method:'POST',
        data:{
            data:data
        },
        url:'api/workschedule/addEmployeeWorkSchedDept'
    })
}
...
export function requestDelSchedDataDept(data){
    return axios.request({
        method:'POST',
        data:{
            data:data
        },
        url:'api/workschedule/requestDelSchedDataDept'
    })
}
export function approvedRequestUpdateSchedData(data){
    return axios.request({
        method:'POST',
        data:data,
        url:'api/workschedule/approvedRequestUpdateSchedData'
    })
}
...
export function getRequestedUpDelData(data){
    return axios.request({
        method:'POST',
        data:{
            data:data
        },
        url:'api/workschedule/getRequestedUpDelData'
    })
}
