import { Autocomplete, Box, Card, CardContent, Chip, Container, FormControl, FormLabel, Grid, InputLabel, Paper, Select, Stack, Table, TableBody, TableCell, TableContainer, TableFooter, TableHead, TableRow, TextField, Typography, styled } from "@mui/material";
...
function ViewRequestForm({ closeModal }) {
    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            try {
                ...
                // let positionFilter = posTitle.position_builder.filter(opt => { if (response1.data.data.position === opt.id) { return opt } });
    ...
    return (
        <>
            {!loading ? (
                <Box sx={{ margin: "0 10px 10px 10px", display: 'flex', gap: '1rem' }}>
                    <Card>
                        <Typography variant="h6" fontWeight={700} sx={{ p: 1, }} textAlign="center"> Request Details </Typography>
                        <CardContent>
                    ...
                    {/* <Card>
                        <CardContent>
                            <Typography variant="h6" fontWeight={700} sx={{ p: 1, }} textAlign="center"> Review and Approval </Typography>
                        </CardContent>
                    </Card> */}
                </Box >
            ) : (
