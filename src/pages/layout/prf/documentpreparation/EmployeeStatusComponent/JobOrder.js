...
function JobOrder({ applicantList, setApplicantList, loader }) {
  ...
  console.log("tempReq JO", tempReq);
            ...
            <>
              <FormControl fullWidth sx={{ gap: "1rem" }}>
                <TextField
                  ...
                  maxRows={4}
                  size="small"
                  label="Work Agreement Terms"
                  value={termsConditionRef}
                  onChange={(ev) => setTermsConditionRef(ev.target.value)}
                />
                <Box>
                  <Button
                    variant="contained"
                ...
                <CardContent>
                            ...
                            {termsConditionBool ? (
                              <Stack sx={{ gap: "0.4rem" }}>
                                ...
                                <Button
                                  ...
                                  color="error"
                                  size="small"
                                  onClick={(ev) => handleRemoveTC(ev, mx)}
                                >
                                  {" "}
                                  remove{" "}
                                </Button>
                  ...
                  <Box>
                    ...
                    >
                      {" "}
                      <InfoOutlinedIcon />{" "}
                      <em> Double click to toggle edit and remove </em>{" "}
                    </Typography>
                  </Box>
                </CardContent>
              </Card>
              ...
              >
                ...
                <Button
                  variant="contained"
                  color={termsConditionBool ? "error" : "primary"}
                  onClick={() => setTermsConditionBool(!termsConditionBool)}
                  size="small"
                >
                  {" "}
                  {termsConditionBool ? "Cancel" : "Edit"}{" "}
                </Button>
            ...
            <>
              <Stack spacing={1}>
                ...
                <TextField
                  ...
                  label="To"
                  onChange={(ev) =>
                    setTimePeriod((prev) => ({ ...prev, to: ev.target.value }))
                  }
                  type="date"
                  size="small"
            ...
            <>
              <FormControl fullWidth>
                <TextField
                  ...
                  rows={2}
                  maxRows={2}
                  InputProps={{ padding: 2, fontSize: "12px" }}
                  placeholder="Enter Job Description"
                  value={joDesc}
                  onChange={(ev) => setJoDesc(ev.target.value)}
                />
              </FormControl>
              <Box
                sx={{
                      ...
                      termsConditionBool ? (
                        ...
                        >
                          <TextField
                            ...
                            InputProps={{ padding: 2 }}
                            onChange={(ev) =>
                              setJoDescription((prev) =>
                                prev.map((m, mx) =>
                                  mx === nx ? ev.target.value : m
                                )
                              )
                            }
                          />
                        ...
                        <li key={nx} style={{ textAlign: "justify" }}>
                          {n}
                        </li>
                      )
                    )}
      ...
      {loading ? (
        ...
        <>
          <Box>
            ...
            >
              <MenuItem onClick={(ev) => handleAction(ev, "view")}>
                {" "}
                View{" "}
              </MenuItem>
              <MenuItem onClick={(ev) => handleAction(ev, "editcontent")}>
                {" "}
                Terms and condition{" "}
              </MenuItem>
              <MenuItem onClick={(ev) => handleAction(ev, "jo-JD")}>
                Job description
              </MenuItem>
                        ...
                        <TableCell>
                          <Stack spacing={1}>
                            ...
                            <Button
                              variant="contained"
                              size="small"
                              onClick={(ev) => handleAction(ev, "jo-POE", i)}
                            >
