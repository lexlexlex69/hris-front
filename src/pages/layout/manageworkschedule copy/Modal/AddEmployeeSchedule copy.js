...
export default function AddEmployeeSchedule(){
    ...
    const saveData = ()=>{
        if(selectedEmployees.length === 0 ){
            ...
            //     var month = el.format('MM')-1;
            //     var year = el.format('YYYY');
            ...
            <Grid container>
                ...
                <Grid item xs={12} >
                    ...
                    <Autocomplete
                        ...
                        <TextField type = 'month' label='Month' value = {selectedMonths} onChange = {(value)=>setSelectedMonths(value.target.value)} InputLabelProps={{shrink:true}}/>
                        {/* <DatePicker
                            multiple
                            onlyMonthPicker 
                            /> */}
