...
export function deletePayrollGroupPerOffice(data){
    return axios.request({
        method:'POST',
        data:data,
        url:'/api/payroll/deletePayrollGroupPerOffice'
    })
}
...
export function getPayType(){
    return axios.request({
        method:'GET',
        // url:api_url+'/gPayType/'+REACT_APP_KEY
...
export function getPayClerk(){
    return axios.request({
        method:'GET',
        // url:api_url+'/gPayClerk/'+REACT_APP_KEY
        url:'/api/payroll/getPayClerk'
    })
}
export function getPayAllowance(){
    return axios.request({
        method:'GET',
        // url:api_url+'/gPayAllowance/'+REACT_APP_KEY
        url:'/api/payroll/getPayAllowance'
    })
}
export function addPayAllowance(data){
    return axios.request({
        method: 'POST',
        data: data,
        url: '/api/payroll/addPayAllowance'
    })
}
export function getPayGroupAPI(){
    return axios.request({
        method:'GET',
        // url:api_url+'/gPayGroup/'+REACT_APP_KEY
        url:'/api/payroll/getPayGroup'
    })
}
export function getDeptPayGroupAPI(dept_code,emp_status){
    return axios.request({
        method:'GET',
        // url:api_url+'/gDeptPayGroup/'+dept_code+'/'+emp_status+'/'+REACT_APP_KEY
        url:'/api/payroll/getDeptPayGroup/'+dept_code+'/'+emp_status
    })
}
...
export function postChangeStatus(data){
    return axios.request({
        method:'POST',
        data:data,
        url:'/api/payroll/postChangeStatus'
    })
}
export function getNewPayGroup(data){
    return axios.request({
        method:'POST',
        data:data,
        url:'api/payroll/getNewPayGroup'
    })
}
export function addNewPayGroup(data){
    return axios.request({
        method:'POST',
        data:data,
        url:'api/payroll/addNewPayGroup'
    })
}