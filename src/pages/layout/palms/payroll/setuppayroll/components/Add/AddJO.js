...
export const AddJO = ({ offices, selectedPaySetup }) => {
    ...
    const beforePrint = () => {
        var logs = {
            ...
            action_dtl: 'JO - ' + 'FROM:' + periodFrom + '| TO:' + periodTo,
            module: 'PAYROLL'
        }
        auditLogs(logs)
        reactToPrintPayroll()
    ...
    useEffect(() => {
        if (selectedEmpDefault.no_days) {
            let earned = selectedEmpDefault.no_days * selectedEmpDefault.m_salary;
            let accrued = earned - selectedEmpDefault.total_wopay;
            if (selectedPaySetup.period_to.includes('15')) {
                setSelectedEmpDefault({
                    ...selectedEmpDefault,
                    earned_15: earned,
                                            ...
                                            return (
                                                ...
                                                >
                                                    ...
                                                    <StyledTableCell align="right">
                                                        {
                                                            item.editable
                                                                ...
                                                                selectedPaySetup.period_to.includes('15')
                                                                    ?
                                                                    formatWithCommas(parseFloat(selectedEmpDefault.earned_15).toFixed(2))
                                                                    :
                                                                    formatWithCommas(parseFloat(selectedEmpDefault.earned_30).toFixed(2))
                                                                :
                                                                selectedPaySetup.period_to.includes('15')
                                                                    ?
                                                    ...
                                                    <StyledTableCell align="right">
                                                        {
                                                            item.editable
                                                                ?
                                                                <TextField type='number' size="small" sx={{ width: 60 }} inputProps={{ style: { fontSize: '.7rem' } }} value={selectedEmpDefault.no_days} onChange={(val) => handleUpdateRow('no_days', item, val)} />
                                                                :
                                                    ...
                                                    <StyledTableCell align="right">
                                                        {
                                                            item.editable
                                                                ?
                                                                <TextField type='number' size="small" sx={{ width: 60 }} inputProps={{ style: { fontSize: '.7rem' } }} value={selectedEmpDefault.wopay_days} onChange={(val) => handleUpdateRow('wopay_days', item, val)} />
                                                                :
                                                    ...
                                                    <StyledTableCell align="right">
                                                        {
                                                            item.editable
                                                                ?
                                                                <TextField type='number' size="small" sx={{ width: 60 }} inputProps={{ style: { fontSize: '.7rem' } }} value={selectedEmpDefault.wopay_hours} onChange={(val) => handleUpdateRow('wopay_hours', item, val)} />
                                                                :
                                                    ...
                                                    <StyledTableCell align="right">
                                                        {
                                                            item.editable
                                                                ?
                                                                <TextField type='number' size="small" sx={{ width: 60 }} inputProps={{ style: { fontSize: '.7rem' } }} value={selectedEmpDefault.wopay_minutes} onChange={(val) => handleUpdateRow('wopay_minutes', item, val)} />
                                                                :
                                                    ...
                                                    <StyledTableCell align="right">
                                                        {
                                                            item.editable
                                                                ?
                                                                <TextField type='number' size="small" sx={{ width: 60 }} inputProps={{ style: { fontSize: '.7rem' } }} value={selectedEmpDefault.pagibig} onChange={(val) => handleUpdateRow('pagibig', item, val)} />
                                                                :
                                                    ...
                                                    <StyledTableCell align="right">
                                                        {
                                                            item.editable
                                                                ?
                                                                <TextField type='number' size="small" sx={{ width: 60 }} inputProps={{ style: { fontSize: '.7rem' } }} value={selectedEmpDefault.sss} onChange={(val) => handleUpdateRow('sss', item, val)} />
                                                                :
                                                    ...
                                                    <StyledTableCell align="right">
                                                        {
                                                            item.editable
                                                                ?
                                                                <TextField type='number' size="small" sx={{ width: 60 }} inputProps={{ style: { fontSize: '.7rem' } }} value={selectedEmpDefault.ph_personal_share} onChange={(val) => handleUpdateRow('ph_personal_share', item, val)} />
                                                                :
                                                    ...
                                                    <StyledTableCell align="right">
                                                        ...
                                                        {/* {
                                                        formatWithCommas((parseFloat((item.earned_amount)-item.total_wopay)-parseFloat(item.tot_contri)).toFixed(2))
                                                    } */}
