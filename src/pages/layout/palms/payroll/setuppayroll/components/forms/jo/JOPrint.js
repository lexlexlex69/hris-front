        ...
        <div id='jo-template' ref={ref}>
            {
                printData.length > 0
                    ...
                    printData.map((item, index) => {
                        return (
                            <div key={index} className={index > 0 ? 'page-break' : ''} style={{
                                padding: '20px',
                                height: '100vh',
                                // width: 'auto'
                                width: '1500px'
                                ...
                                <PayrollPager id='footer-content-default' page={index + 1} totalPage={printData.length} user={props.user} payrollno={props.selectedOffice.payroll_no ?? '-'} groupname={props.selectedOffice.group_name ?? '-'} />
