...
export const Casual = ({ loanType, offices, tabValue, tempDetails }) => {
    ...
    return (
        <Box>
            <PayrollDtl loanType={loanType} cat={2} empStatus='CS' empStatusName='Casual' offices={offices} tabValue={tabValue} tempDetails={tempDetails}/>
