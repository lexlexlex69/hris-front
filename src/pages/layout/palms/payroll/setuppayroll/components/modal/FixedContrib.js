import { Autocomplete, Box, Button, Grid, IconButton, Paper, Table, TableBody, TableCell, TableContainer, TableHead, TableRow, TextField, Tooltip } from '@mui/material';
...
export const FixedContrib = ({data,updateData,close,offices}) =>{
