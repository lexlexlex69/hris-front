...
import { deleteEmpPayrollGroup, getEmpPerDeptStatus, getPayrollGroupPerOffice, getPayrollGroupings } from '../../SetupPayrollRequests';
                                        ...
                                        return(
                                            <TableRow key={item.id}>
                                                ...
                                                <TableCell>
                                                    ...
                                                    <Button variant='contained' color = 'error' startIcon={<DeleteIcon/>}onClick = {()=>handleDelete(item)} size='small' className='custom-roundbutton'>Remove</Button>
                                                    </Tooltip>
                                                </TableCell>
                                            </TableRow>
                                        )
