...
import { CasualPrint } from '../../../setuppayroll/components/forms/casual/CasualPrint';
import { COSPrint } from '../../../setuppayroll/components/forms/cos/COSPrint';
export const COSPay = ({ loanType, signatories, user }) => {
    ...
    return (
        <Grid container>
            ...
            <div style={{ display: 'none' }}>
                <COSPrint ref={printPayroll} empList={data} loans={[]} signatories={signatories} selectedOffice={selectedPayroll} periodFrom={selectedPayroll?.period_from} periodTo={selectedPayroll?.period_to} wTax={[]} user={user} />
            </div>
        </Grid>
    )
}