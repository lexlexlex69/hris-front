...
export const CasualPay = ({loanType,signatories,user}) => {
    ...
    return (
        <Grid container>
            ...
            <div style={{display:'none'}}>
                <CasualPrint ref={printPayroll} empList = {data} loans = {loans} signatories={signatories} selectedOffice = {selectedPayroll} periodFrom = {selectedPayroll?.period_from} periodTo = {selectedPayroll?.period_to} user={user}/>
            </div>
        </Grid>
    )
}