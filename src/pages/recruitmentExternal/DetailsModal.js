        ...
        <Table size="small">
          <TableBody>
            ...
            <TableRow>
              ...
              <TableCell>{data.position_title}</TableCell>
            </TableRow>
            <TableRow>
              <TableCell>Plantilla No:</TableCell>
              <TableCell>{data.plantilla_no}</TableCell>
            </TableRow>
            <TableRow>
              <TableCell>Salary/Job/Pay Grade:</TableCell>
              <TableCell>{data.salary_grade}</TableCell>
            </TableRow>
            <TableRow>
              <TableCell>monthly Salary:</TableCell>
              <TableCell>{data.monhtly_salary}</TableCell>
            </TableRow>
            <TableRow>
            ...
            <TableRow>
              ...
              <TableCell>{data.training}</TableCell>
            </TableRow>
            <TableRow>
            ...
            <TableRow>
              <TableCell>Work Experience:</TableCell>
              <TableCell>{data.compentency}</TableCell>
            </TableRow>
          </TableBody>
        </Table>
      </TableContainer>
